    ...
    return (
        <div className="min-h-screen bg-primary flex flex-col items-center justify-center p-10 gap-8">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl mb-3">
                ...
                <div className="relative rounded-2xl p-6 shadow-light-purple transition-shadow hover:scale-[1.02] duration-300 hover:shadow-[0_0_30px_5px_rgba(168,85,247,0.5)]">
            ...
            <div className="flex-1 w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-6 relative rounded-2xl p-6 shadow-light-purple transition-shadow hover:scale-[1.02] duration-300 hover:shadow-[0_0_30px_5px_rgba(168,85,247,0.5)]">
                <div>
                    <div className="flex items-start gap-4 mb-2">
