...
const CallToActionBtn = ({ hero = false }) => {
    ...
    return (
        <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
                to="/#"
                className={`${hero ? "hidden md:flex" : ""} items-center px-4 md:px-8 py-2 text-white font-bold text-lg rounded-full shadow-lg transition-transform transform bg-transparent border-2 border-white hover:scale-105 hover:border-secondary hover:shadow-secondary/50 hover:shadow-2xl focus:outline-none duration-300`}
            >
                Talk to an expert
            </Link>
